      ...
      <div className="flex pt-[112px] items-center justify-start flex-col min-h-screen py-12 px-4 sm:px-6 lg:px-8">
        <div className="w-full max-w-[364px]">
          ...
          {passwordError && (
            <div className="mb-6 p-3 bg-red-50 border border-red-200 rounded-lg">
              <div className="flex items-center">
                ...
                <p className="text-sm text-red-600 font-medium" style={{ fontFamily: 'DM Sans' }}>
                  {passwordError}
                </p>
              </div>
            </div>
          ...
          <div className="text-center mb-8">
            <h1 className="text-[36px] md:text-[48px] font-semibold text-gray-900 mb-3 leading-[28px] tracking-[-0.2px]" style={{ fontFamily: 'DM Sans' }}>
              Create account
            </h1>
            <p className="text-sm text-gray-600 leading-[20px] tracking-[-0.17px]" style={{ fontFamily: 'DM Sans' }}>
              Join now to start shopping and enjoy complete access to everything we offer.
            </p>
          </div>
          ...
          <div className="relative mb-8">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-white text-gray-500" style={{ fontFamily: 'DM Sans' }}>Or sign up with email</span>
            </div>
          </div>
          ...
          <form>
            ...
            <div className="mb-6">
              <label htmlFor="confirmPassword" className="block text-sm font-medium text-gray-700 mb-2 leading-[20px] tracking-[-0.17px]" style={{ fontFamily: 'DM Sans' }}>
                Re-type Password *
              </label>
              <div className="relative">
                <input
