      ...
      >
        <div className="flex flex-col gap-3 px-4 py-3 sm:flex-row sm:items-center sm:justify-between sm:px-6 sm:py-4">
          <div className="flex flex-col gap-1">
            ...
            <p className={`text-theme-sm ${theme === "dark" ? "text-[#98A2B3]" : "text-[#667085]"}`}>
          ...
          <div className="flex flex-wrap items-center gap-3 sm:w-auto w-full">
            {/* Search input */}
            <div className={`flex items-center gap-2 rounded-lg px-3 py-2 shadow-theme-xs flex-1 min-w-[200px] border ${
              theme === "dark"
              ...
              <input
                ...
                className={`text-sm outline-none w-full bg-transparent ${
                  theme === "dark"
                    ? "placeholder:text-[#98A2B3] text-white/90"
            ...
            {/* Date button */}
            <button className={`inline-flex items-center gap-2 rounded-lg border px-3 py-2 text-theme-sm font-medium shadow-theme-xs whitespace-nowrap ${
              theme === "dark"
              ...
              {loading && (
                <TableRow>
                  <TableCell className="py-4" colSpan={4}>
                    <span className={theme === "dark" ? "text-[#98A2B3]" : "text-[#667085]"}>Loading products...</span>
                  </TableCell>
                </TableRow>
              )}
              {error && !loading && (
