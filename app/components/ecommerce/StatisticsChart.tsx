    ...
    yaxis: {
      labels: {
        style: {
          ...
          colors: "var(--secondary)", // Color of the labels
        },
      },
      title: {
  ...
  return (
    <div
      className={`rounded-2xl border px-5 pb-5 pt-5 sm:px-6 sm:pt-6 ${
        theme === "dark" ? "border-gray-800 bg-white/[0.03]" : "border-gray-200 bg-white"
      }`}
    >
      <div className="flex flex-col gap-5 mb-6 sm:flex-row sm:justify-between">
        <div className="w-full">
          <h3 className={`text-lg font-semibold ${ theme === "dark" ? " text-white/90 ":"text-gray-800"} `}>
            Statistics
          </h3>
          <p
