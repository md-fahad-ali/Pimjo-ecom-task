  ...
  return (
    <div className="relative">
      <button
        ...
        className={`flex items-center dropdown-toggle ${theme === 'dark' ? 'text-gray-400' : 'text-gray-700'}`}
      >
      ...
      <Dropdown
        ...
        className={`absolute right-0 mt-[17px] flex w-[260px] flex-col rounded-2xl border p-3 `}
        style={
          theme === 'dark'
      ...
      >
        ...
        <ul className="flex flex-col gap-1 pt-4 pb-3 border-b" style={{ borderColor: 'var(--border)' }}>
          <li>
            <DropdownItem
