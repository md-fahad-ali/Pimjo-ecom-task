...
const AppHeader: React.FC = () => {
  ...
  return (
    <header
      className="sticky top-0 flex w-full z-99999 lg:border-b overflow-visible"
      style={{ backgroundColor: theme === 'dark' ? 'var(--background)' : 'var(--panel)', borderColor: 'var(--border)' }}
    >
            ...
            <form>
              <div className="relative">
                ...
                <input
                  ...
                  className="h-11 w-full rounded-lg border dark:bg-white/[0.03] py-2.5 pl-12 pr-14 text-sm shadow-theme-xs focus:outline-hidden xl:w-[430px]"
                  style={{
                    backgroundColor: theme === 'dark' ? 'rgba(255,255,255,0.03)' : 'var(--panel)',
                    borderColor: 'var(--border)',
                ...
                <button 
                  ...
                  style={{
                    borderColor: theme === 'dark' ? '#253049' : 'var(--border)',
                    backgroundColor: theme === 'dark' ? 'rgba(255,255,255,0.06)' : 'var(--panel)',
                    color: theme === 'dark' ? '#98A2B3' : 'var(--secondary)'
                  }}
                >
                  <span> ⌘ </span>
                  <span> K </span>
